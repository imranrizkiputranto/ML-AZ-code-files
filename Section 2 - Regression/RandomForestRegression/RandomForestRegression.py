...
Creating a random forest regression model relating an individual's position and their salaries
"""
...
plt.title('Salaries Against Position (Random Forest Regression)')
plt.xlabel('Position')
plt.ylabel('Salary')
plt.show()
